...
" Generate list with: rg -o '"@([^",]+)' -r '$1' firejail/src/fseccomp/syscall.c | sort -u | tr $'\n' '|'
...
" Errnos grabbed from: https://github.com/netblue30/firejail/blob/master/src/fseccomp/errno.c (commit 3d84845f859cd3d200eb92a1308dfda7e1374fec)
" Generate list with: rg -o '"(E[^"]+)' -r '$1' firejail/src/fseccomp/errno.c | sort -u | tr $'\n' '|'
...
" Variable names grabbed from: https://github.com/netblue30/firejail/blob/master/src/firejail/macros.c (commit 3d84845f859cd3d200eb92a1308dfda7e1374fec)
" Generate list with: rg -o '\$\{([^}]+)\}' -r '$1' firejail/src/firejail/macros.c | sort -u | tr $'\n' '|'
